const ServiceCard = ({ icon, title }) => {    
    ...
    return (
      <>
        <div
            className="relative sm:m-10 m-5 grid h-[15rem] w-full max-w-[15rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
            <div
